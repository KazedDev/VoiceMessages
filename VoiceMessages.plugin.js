/**
 * @name VoiceMessages
 * @author Riolubruh x Kazed
 * @authorLink https://github.com/KazedDev
 * @description Allows you to send voice messages like on mobile. To do so, click the upload button and click Send Voice Message. **( And desable Krisp For a lot of JACKET! player. )**
 * @version 0.1.3
 * @invite EFmGEWAUns
 * @source https://github.com/Kazeddev/VoiceMessages
 */
/*@cc_on
@if(@_jscript)
...
const config = {
	"info": {
		...
		"authors": [{
			"name": "Kazed",
			"discord_id": "1245080995258957967",
			"github_username": "Kazed"
		}],
		"version": "0.1.3",
		"description": "Allows you to send voice messages like on mobile. To do so, click the upload button and click Send Voice Message. **( And desable Krisp For a lot of JACKET! player. )** ",
		"github": "https://github.com/Kazed/VoiceMessages",
		"github_raw": "https://github.com/KazedDev/VoiceMessages/blob/main/VoiceMessages.plugin.js"
	},
	changelog: [
		{
			title: "0.1.3",
